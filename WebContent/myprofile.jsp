                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <a href="#">
                                        <img width="200px" style="margin-top:15px" height="200px"
                                           src="resources/images/default_image_user.jpg"
                                ...
                                <div class="col">
                                    <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                        <div>
                                            ...
                                            <span class="description">Atividades feitas</span>
                                        </div>
                                        <div>
                                            <span class="heading">4</span>
                                            <span class="description">Atividades pendentes</span>
                                        </div>
                                        <div>
                                            <span class="heading">10</span>
                                            <span class="description">Total de atividades</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                <label class="form-control-label"
                                                    for="input-last-name">Sobrenome</label>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="input-postal-code"
                                                    class="form-control form-control-alternative" placeholder="Cep"
                                                    value="05266130">
                                            </div>
                                        </div>
                                    </div>
