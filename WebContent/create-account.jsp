				...
				<div class="card-body">
					...
					<form action="cliente" method="post">
						...
						<div class="row row-space">
							<div class="col-2">
								<div class="input-group">
									<label class="label">Primeiro nome</label> <input
						...
						<div class="row row-space">
							...
							<div class="col-2">
								<div class="input-group">
									<label class="label">Número Telefone</label> <input
										class="input--style-4" type="number" name="phone">
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
									<label class="label">Altura</label> <input
										class="input--style-4" type="number" name="height">
								</div>
							</div>
							<div class="col-2">
								<div class="input-group">
								...
								<div class="input-group">
									<label class="label">Confirmar Senha</label> <input
										class="input--style-4" type="password" name="confirm-password">
								</div>
							</div>
						</div>
						<div class="p-t-15">
